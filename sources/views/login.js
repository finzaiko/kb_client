...
export default class LoginView extends JetView{
    config(){
        const login_form = {
            ...
            rows:[
                { view:"text", name:"login", label:"User Name", labelPosition:"top", value: "arifin2" },
                { view:"text", type:"password", name:"pass", label:"Password", labelPosition:"top", value: "arifin123" },
